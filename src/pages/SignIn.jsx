  ...
  const handleForm = async (e) => {
    ...
    try {
      ...
      const response = await axios.post(
        "https://desafio-lexart-backend.vercel.app/auth/login",
        {
          email,
          password,
        }
  ...
  return (
    ...
    <div class="flex justify-center min-h-screen bg-gray-100">
      <div class="container sm:mt-40 mt-16 my-auto max-w-md border-2 border-gray-200 p-3 bg-white">
        ...
        {/* <!-- sign-in --> */}
        <div class="m-6">
          <form onSubmit={handleForm} class="mb-4">
            <div class="mb-6">
              <label
                for="email"
            ...
            <div class="mb-6">
              <button
                type="submit"
                class="w-full px-3 py-4 text-white bg-indigo-500 rounded-md hover:bg-indigo-600 focus:outline-none duration-100 ease-in-out block text-center"
              >
                Login
              </button>
